  ...
  .define(PersonDetail, async ({ faker }) => {
    return {
      ...
      social_media: faker.datatype.boolean({ probability: 0.4 }) ? {
        facebook: faker.datatype.boolean({ probability: 0.3 }) ? faker.internet.userName() : undefined,
        instagram: faker.datatype.boolean({ probability: 0.3 }) ? faker.internet.userName() : undefined,
        twitter: faker.datatype.boolean({ probability: 0.2 }) ? faker.internet.userName() : undefined,
        linkedin: faker.datatype.boolean({ probability: 0.2 }) ? faker.internet.userName() : undefined
      } : null,
      documents: faker.datatype.boolean({ probability: 0.6 }) ? {
        cpf: faker.string.numeric(11),
        rg: faker.string.numeric(9),
        voter_id: faker.datatype.boolean({ probability: 0.5 }) ? faker.string.numeric(12) : undefined
      } : null,
      api_data: null
    }
  })
